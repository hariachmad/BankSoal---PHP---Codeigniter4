                    ...
                    <div class="btn-group-vertical btn-group-toggle" data-toggle="buttons">
                        <div>
                            <label class="btn btn-outline-primary <?php if ($jawaban_dipilih === 'jawaban_a')
                                echo 'active'; ?>">
                                <input type="radio" class="btn-check" name="jawaban[<?= $k['id'] ?>][]" value="jawaban_a"
                                    <?php if ($jawaban_dipilih === 'jawaban_a')
                                        echo 'checked'; ?>> A
                            </label>
                        ...
                        <div>
                            <label class="btn btn-outline-primary <?php if ($jawaban_dipilih === 'jawaban_b')
                                echo 'active'; ?>">
                                <input type="radio" class="btn-check" name="jawaban[<?= $k['id'] ?>][]" value="jawaban_b"
                                    <?php if ($jawaban_dipilih === 'jawaban_b')
                                        echo 'checked'; ?>> B
                            </label>
                            <label class="form-check-label ml-2"
                        ...
                        <div>
                            <label class="btn btn-outline-primary <?php if ($jawaban_dipilih === 'jawaban_c')
                                echo 'active'; ?>">
                                <input type="radio" class="btn-check" name="jawaban[<?= $k['id'] ?>][]" value="jawaban_c"
                                    <?php if ($jawaban_dipilih === 'jawaban_c')
                                        echo 'checked'; ?>> C
                            </label>
                            <label class="form-check-label ml-2"
                        ...
                        <div>
                            <label class="btn btn-outline-primary <?php if ($jawaban_dipilih === 'jawaban_d')
                                echo 'active'; ?>">
                                <input type="radio" class="btn-check" name="jawaban[<?= $k['id'] ?>][]" value="jawaban_d"
                                    <?php if ($jawaban_dipilih === 'jawaban_d')
                                        echo 'checked'; ?>> D
                            </label>
                            <label class="form-check-label ml-2"
